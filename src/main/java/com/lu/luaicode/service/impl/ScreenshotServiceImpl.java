...
import com.lu.luaicode.manager.CosManager;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        ThrowUtils.throwIf(StrUtil.isBlank(localScreenshotPath), ResultCode.DATA_OPERATION_FAIL, "本地截图生成失败");
        try {
            // 2. 上传到对象存储
            String cosUrl = uploadScreenshotToCos(localScreenshotPath);
            ThrowUtils.throwIf(StrUtil.isBlank(cosUrl), ResultCode.DATA_OPERATION_FAIL, "截图上传对象存储失败");

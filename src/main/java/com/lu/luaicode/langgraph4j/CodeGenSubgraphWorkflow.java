...
import com.lu.luaicode.langgraph4j.node.concurrent.*;
...
public class CodeGenSubgraphWorkflow {
    ...
    private StateGraph<MessagesState<String>> createIllustrationSubgraph() {
        try {
            ...
            throw new BusinessException(ResultCode.DATA_OPERATION_FAIL, "插画子图创建失败");
        }
    }
    ...
    private StateGraph<MessagesState<String>> createDiagramSubgraph() {
        try {
            ...
            throw new BusinessException(ResultCode.DATA_OPERATION_FAIL, "架构图子图创建失败");
        }
    }
    ...
    private StateGraph<MessagesState<String>> createLogoSubgraph() {
        try {
            ...
            throw new BusinessException(ResultCode.DATA_OPERATION_FAIL, "Logo子图创建失败");
        }
    }
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            ...
            throw new BusinessException(ResultCode.DATA_OPERATION_FAIL, "子图工作流创建失败");
        }
    }
